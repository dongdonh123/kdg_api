...
public class MenuTreeDTO {
    ...
    private int top_menu_id;
    private String top_menu_name;
    private List<Integer> child_menu_id_list;
    ...
    public MenuTreeDTO(int menu_id, String menu_name,List<Integer> menu_id_list, List<String> menu_name_list) {
    ...
    public void setTop_menu_id(int top_menu_id) {
    ...
    public void setChild_menu_id_list(List<Integer> child_menu_id_list) {
    ...
    public List<Integer> getChild_menu_id_list() {
